...
class TestDeepLearningFlow:
    ...
    def test_training_page_loads(self, page: Page):
        """测试训练页面加载"""
        page.goto("http://localhost:3000/deep-learning/train")
        expect(page.locator("body")).to_be_visible()
    
    def test_inference_page_loads(self, page: Page):
        """测试推理页面加载"""
        page.goto("http://localhost:3000/deep-learning/inference")
        expect(page.locator("body")).to_be_visible()
    
    def test_model_management_page_loads(self, page: Page):
        """测试模型管理页面加载"""
        page.goto("http://localhost:3000/deep-learning/models")
        expect(page.locator("body")).to_be_visible()
    
    def test_data_preprocessing_page_loads(self, page: Page):
        """测试数据预处理页面加载"""
        page.goto("http://localhost:3000/deep-learning/preprocess")
        expect(page.locator("body")).to_be_visible()
